...
| MONO-04 | Path aliases configured (@/* -> src/*, @ui/* -> packages/ui/src/*, @types/* -> packages/types/src/*) | Must be configured in BOTH tsconfig.json `paths` (type checking) AND vite.config.ts `resolve.alias` (bundling). They are independent systems. |
