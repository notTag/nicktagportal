...
plan: 03
subsystem: infra
tags: [eslint, prettier, husky, lint-staged, tailwindcss-class-sorting, vue3-linting]
...
# Tech tracking
tech-stack:
  added: [eslint@10.1, eslint-plugin-vue@10.8, "@vue/eslint-config-typescript@14.7", prettier@3.8, prettier-plugin-tailwindcss@0.7, husky@9.1, lint-staged@16.4]
  patterns: [eslint-flat-config, prettier-tailwind-sorting, pre-commit-lint-staged]
