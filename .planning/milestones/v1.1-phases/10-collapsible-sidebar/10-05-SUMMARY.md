...
- FOUND: apps/shell/src/layouts/**tests**/AppLayout.test.ts (rewritten, 10 tests)
...
- FOUND: packages/ui/src/**tests**/index.test.ts (length-7 assertion)
...
- FOUND-ABSENT: packages/ui/src/components/**tests**/TheHeader.test.ts
- FOUND-ABSENT: packages/ui/src/components/**tests**/MobileMenu.test.ts
