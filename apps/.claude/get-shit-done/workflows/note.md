...
- **Global scope**: `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/notes/`)
...
2. Glob `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/notes/` — works in any directory
