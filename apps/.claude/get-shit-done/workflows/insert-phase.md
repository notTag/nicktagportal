...
```bash
INIT=$(node "/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
