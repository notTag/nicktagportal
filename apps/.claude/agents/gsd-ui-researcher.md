...
Use template from `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/nicktag/Code/Projects/nicktagtech/nicktagportal/apps/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
